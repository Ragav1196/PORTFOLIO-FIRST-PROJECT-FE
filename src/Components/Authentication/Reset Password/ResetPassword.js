...
export function ResetPassword() {
  ...
  const formValidationSchema = yup.object({
    ...
    // oneOf => any one of the value inside the array should be the filled value, if anything else validation become false
    // yup.ref => this is used to refer other field values
  });
  ...
  return (
    <section className="RP_MainCntr">
      <article className="RP_HeaderCntr">
        <svg
      ...
      <article className="RP_FrgtPwdCntr">
        <div>
