...
export function Login({ setFrndsLst, setGrpsLst }) {
  ...
  return (
    <section onClick={() => setLoginError(false)} className="L_MainCntr">
      <article className="L_HeaderCntr">
        <svg
      ...
      <article className="L_LoginDtlCntr">
        <div>
          <h1>LOG IN</h1>
          <form onSubmit={handleSubmit}>
            {loginError ? (
              <p className="L_LoginError">INVALID CREDENTIALS</p>
            ) : (
              ""
            )}
            <label htmlFor="email">
              ...
              {errors.email && touched.email ? (
                <div className="L_Error">{errors.email}</div>
              ) : (
                ""
              )}
            </label>
            <label htmlFor="password">
              ...
              {errors.password && touched.password ? (
                <div className="L_Error">{errors.password}</div>
              ) : (
                ""
              )}
            </label>
            ...
            <p className="L_FrgtPwd">Forgot your password?</p>
